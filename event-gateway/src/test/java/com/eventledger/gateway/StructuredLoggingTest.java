...
class StructuredLoggingTest {
    ...
    void logLineIsSingleLineJsonWithRequiredFields() throws Exception {
        ...
        encoder.setCustomFields("{\"service\":\"event-gateway\"}");
        encoder.start();

        LoggingEvent event = new LoggingEvent();
        event.setLoggerName("com.eventledger.gateway.StructuredLoggingTest");
        ...
        assertThat(json.path("service").asText()).isEqualTo("event-gateway");
        assertThat(json.path("traceId").asText()).isEqualTo("trace-abc123");
        assertThat(json.path("spanId").asText()).isEqualTo("span-def456");
        assertThat(json.path("logger").asText()).isEqualTo("com.eventledger.gateway.StructuredLoggingTest");
